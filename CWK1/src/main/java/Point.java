...
public class Point {
  ...
  Point(ZonedDateTime time,double latitude,double longitude,double elevation){
    this.time = time;
  ...
  public double getLatitude() throws GPSException{
  ...
  public double getLongitude() throws GPSException{
  ...
  public String toString(){
    String str = String.format("(%d,%d),%d",longitude,latitude,elevation);
    return str;
  }
